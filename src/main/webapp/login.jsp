    ...
    <div class="layui-anim layui-anim-up">
        <div class="layui-container">
            ...
            <div class="layui-row layui-col-space10">
                    ...
                    <form class="layui-form" method="post">
                       ...
                       <%-- <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <img src="${pageContext.request.contextPath}/DrawValidateCode?${pageContext.session.id}" height="42px" width="39%" onclick="changeValidateCode()" id="ValidateCode" title="看不清楚？单击换一张！">
                            </div>
                        </div>--%>
                        <br>
                        <div class="layui-form-item">
                            ...
                            <button class="layui-btn layui-btn-normal" id="registerButton">
                ...
                <div class="layui-row">
                    <hr class="layui-bg-gray">
                    <center><p style="color: white;"><i class="layui-icon layui-icon-auz"></i> copy right @qq.com</p></center>
                </div>
