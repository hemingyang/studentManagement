...
public class LoginFilter implements Filter{ //登录验证过滤器
    ...
    public void doFilter(ServletRequest req, ServletResponse resp,
        ...
        if(path.contains("login.jsp") || path.contains("/login") ||path.contains("register.jsp") ||path.contains("/addUser") || path.contains("/DrawValidateCode") || path.contains("/layui") || path.contains("/image")){
